...
function changeImports()
{
    ...
    if (fs.existsSync(exampleFilePath))
    {
        ...
        {
            if (err) {return console.log(err)}
            const stringResult = data.replace('import { AbilityLocalization, LocalizationData, ModifierLocalization, GeneralLocalization } from "../localizationInterfaces";',
                                              'import { AbilityLocalization, LocalizationData, ModifierLocalization, GeneralLocalization } from "~generator/localizationInterfaces";')
